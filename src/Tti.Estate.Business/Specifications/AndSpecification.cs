...
{
    public class AndSpecification<TEntity> : IAsyncSpecification<TEntity>
        where TEntity : BaseEntity
    {
        private readonly IAsyncSpecification<TEntity> _leftSpec;
        private readonly IAsyncSpecification<TEntity> _rightSpec;

        public AndSpecification(IAsyncSpecification<TEntity> leftSpec, IAsyncSpecification<TEntity> rightSpec)
        {
            _leftSpec = leftSpec;
